...
function requestAll(urlList, cb) {
    ...
    /**
     * Streams here could be done in a more appropriate way. It would be batter if we create another
     * file and write this request all function inside that and export stream.
     *
     * Later we import that stream into and use it to subsribe to that stream.
     */
